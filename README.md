...
- `artillery/` — built copy of apollyon-sys/wardogs-calculator (MIT), L81 mortar and SPH-2 artillery calculator with team map; rebuild from upstream with `npm run build` and copy `dist/` here
